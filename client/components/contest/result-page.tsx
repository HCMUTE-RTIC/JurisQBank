        ...
        <Result
               ...
               <Progress 
                 ...
                 format={() => (
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-xs text-gray-400">/ {resultData.totalScore} điểm</span>
                    </div>
                 )}
                 size={140}
          ...
          title={
            <span className={`text-2xl font-bold ${isPassed ? 'text-green-600' : 'text-red-600'}`}>
              {isPassed ? "Chúc mừng! Bạn đã vượt qua bài thi" : "Rất tiếc! Bạn chưa đạt yêu cầu"}
            </span>
          }
          subTitle={
          ...
          // 4. Action buttons
          extra={[
            <div key="actions" className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
        ...
        >
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                <Row gutter={[24, 24]} justify="center">
                      <Col xs={12} sm={6}>
                        <Statistic
                            title={<span className="text-gray-500 text-sm">Số câu hỏi</span>}
                    ...
                    <Col xs={12} sm={6}>
                        <Statistic
                            title={<span className="text-gray-500 text-sm">Số câu đúng</span>}
                    ...
                    <Col xs={12} sm={6}>
                        <Statistic
                            title={<span className="text-gray-500 text-sm">Số câu sai</span>}
                    ...
                    <Col xs={12} sm={12}>
                        <Statistic
                            title={<span className="text-gray-500 text-sm">Thời gian</span>}
            ...
            <div className="mt-8 text-center bg-blue-50 p-4 rounded-lg">
                <Paragraph className="mb-0 text-blue-700">
                    Kết quả đã được lưu vào hệ thống lúc <b>{new Date().toLocaleString()}</b>
                </Paragraph>
            </div>
        </Result>
      </Card>
